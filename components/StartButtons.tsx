    ...
    <>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex flex-col gap-4">
          <button
            className="w-full bg-orange-100 hover:bg-orange-200 border border-orange-300 rounded px-4 py-2 font-semibold"
            onClick={() => router.push('/quiz/movie')}
          >
            🎬 Movies & TV Shows
          </button>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="flex flex-col gap-4">
          <button
            className="w-full bg-green-100 hover:bg-green-200 border border-green-300 rounded px-4 py-2 font-semibold"
            onClick={() => router.push('/quiz/food')}
          >
            🍽️ Food
          </button>
